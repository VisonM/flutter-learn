...
class ScrollableTabDemo extends StatefulWidget{
  ...
  _ScrollableTab createState()=> _ScrollableTab();
}
enum TabsDemoStyle {
  iconsAndText,
  iconsOnly,
...
class _ScrollableTab extends State<ScrollableTabDemo> with SingleTickerProviderStateMixin{
